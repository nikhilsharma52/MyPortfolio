...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Nikhil Sharma
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I bring a understanding of crafting dynamic web and mobile applications. Proficient in several programming languages, I am adept at utilizing frameworks and libraries to build innovative solutions</p>
